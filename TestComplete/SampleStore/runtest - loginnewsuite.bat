...
testcomplete.exe "D:\TestProScripts\TestComplete\ProjectSuite_Java\ProjectSuite1\ProjectSuite1.pjs" /run /project:SampleStore /test:"Script|Login|TCValidLogin" "Data=%projectdir%\testdata\validcred.xlsx" "Sheet=valid" /SilentMode /ExportLog:"%resultsdir%\Log3.html" /exit

testcomplete.exe "D:\TestProScripts\TestComplete\ProjectSuite_Java\ProjectSuite1\ProjectSuite1.pjs" /run /project:SampleStore /test:"Script|Browser|CloseStore" "Data=%projectdir%\testdata\validcred.xlsx" "Sheet=valid" /SilentMode /ExportLog:"%resultsdir%\Log4.html" /exit

start chrome %resultsdir%\Log1.html
start chrome %resultsdir%\Log2.html
start chrome %resultsdir%\Log3.html
start chrome %resultsdir%\Log4.html
pause